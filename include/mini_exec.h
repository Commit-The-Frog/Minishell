...
void	heredoc_sub_preprocess(t_redir_node *redirect, int *cnt, char *start_dir, int get_input);
void	heredoc_preprocess(t_pipe_node *head, int *cnt, char *start_dir, int get_input);
